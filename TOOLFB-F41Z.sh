...
echo $i" |"$cy"     ANONYMOUS CYBER PEMULA"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku"MR.F"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" MR.F"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"*LASKAR CYBER ANONYMOUS"$i"  |"
echo $i" |"$cy"            KAMI ADA , KAMI NYATA"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 085220205961"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" PSGJLOYALIS62@GMAIL.COM"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $cy"THANK TO ALL"
sleep 2
echo $i"SEMOGA WORK SESUAI KEINGINAN ANDA"
sleep 2
echo $ku"WhatsApp :"$i" 085220205961"
echo $ku"Facebook :"$i" MR.F"
sleep 2
echo $pur">> MAKSIH SEMUANYA  <<"
exit
fi
